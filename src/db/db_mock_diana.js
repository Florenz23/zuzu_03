...
const createUser = () => {
    ...
    let userData_hashTagData_color = createConnectData('Hobby','Fotographie, Kunst')
    let userData_hashTagData_hobby = createConnectData('Praktikum','WebDesign creative GmbH')
    let userData_hashTagData_subject = createConnectData('Studiengang','Anglistik und digitale Designtechnik')
